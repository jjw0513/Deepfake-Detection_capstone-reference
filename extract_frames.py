...
# parser.add_argument('--out_root', help='path to output directory', default='D:/train_frames')
# parser.add_argument('--num_frames', type=int, help='the number of frames to extract', default=20)
# parser.add_argument('--label_file', type=str, help='path to save label file', default='labels2.txt')
...
#     for label_name, label in [('fake3', 1)]:
...
parser = argparse.ArgumentParser(description='Extract frames and label videos')
parser.add_argument('--input_root', help='path to root directory containing fake, real, and real2 directories')
parser.add_argument('--out_root', help='path to output directory', default='D:/train_frames2')
